...
class SEQUOIA_SAMPLES:
    """!
    @brief  Sequoia samples offers a set of datapoints by SEQUOIA Benchmark 2000.  
    """

    COLLECTION_PATH         = DEFAULT_SAMPLE_PATH + "sequoia" + os.sep

    SAMPLE_SEQUOIA1252      = COLLECTION_PATH + "sequoia1252.data"
    SAMPLE_SEQUOIA2503      = COLLECTION_PATH + "sequoia2503.data"
    SAMPLE_SEQUOIA3910      = COLLECTION_PATH + "sequoia3910.data"
    SAMPLE_SEQUOIA5213      = COLLECTION_PATH + "sequoia5213.data"
    SAMPLE_SEQUOIA6256      = COLLECTION_PATH + "sequoia6256.data"
    SAMPLE_SEQUOIA7820      = COLLECTION_PATH + "sequoia7820.data"
    SAMPLE_SEQUOIA8937      = COLLECTION_PATH + "sequoia8937.data"
    SAMPLE_SEQUOIA10426     = COLLECTION_PATH + "sequoia10426.data"
    SAMPLE_SEQUOIA12512     = COLLECTION_PATH + "sequoia12512.data"
